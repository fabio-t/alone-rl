...
| [rlforj-alt](https://github.com/fabio-t/rlforj-alt) | BSD-3-Clause | Field of view, line of sight, pathfinding (git submodule `vendor/rlforj-alt` pinned at `0.3.0`; will become a Gradle source dependency built from GitHub — see `settings.gradle.kts`) |
